...
from Nethya.Handlers.msg_types import Types
from Nethya.Database import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} just joined. EverNethya, look busy!",
    ...
    "EverNethya stop what you’re doing, We are now in the presence of {first}.",
