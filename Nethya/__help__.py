import importlib, re
from Nethya import dispatcher, ALLOW_EXCL, LOGGER
from telegram import InlineKeyboardButton, InlineKeyboardMarkup, ParseMode, Update
from Nethya.Handlers.misc import paginate_modules
