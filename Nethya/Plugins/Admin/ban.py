...
from Nethya.Handlers.extraction import extract_user_and_text
from Nethya.Handlers.string_handling import extract_time
from Nethya.Plugins.Admin.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text(
                "Bring an order from Nethya Management to fight a Requester."
            )
        else:
