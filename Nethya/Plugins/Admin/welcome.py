...
import Nethya
import Nethya.Database.welcome_sql as sql
import Nethya.Database.global_bans_sql as gban_sql
from Nethya import (
    REQUESTER, DEV_USERS, INSPECTOR, JOIN_LOGGER, LOGGER,
    OWNER_ID, dispatcher
)
from Nethya.Handlers.validation import (
    is_user_ban_protected, user_admin, connection_status,
)
from Nethya.Handlers.misc import (
    build_keyboard,
    revert_buttons,
)
from Nethya.Handlers.msg_types import get_welcome_type
...
def welcome(update: Update, context: CallbackContext):
    ...
    if not args or args[0].lower() == "noformat":
        ...
        if args[0].lower() in ("on", "yes"):
            ...
            update.effective_message.reply_text(
                "I'll go loaf around and not welcome anNethya then.",
            )
