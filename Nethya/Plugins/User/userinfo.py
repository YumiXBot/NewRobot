...
from Nethya.__help__ import STATS, USER_INFO
import Nethya.Database.userinfo_sql as sql
from Nethya.Plugins.disable import DisableAbleCommandHandler
from Nethya.Database.global_bans_sql import is_user_gbanned
from Nethya.Database.afk_sql import is_afk, check_afk_status
from Nethya.Database.users_sql import get_user_num_chats
from Nethya.Handlers.validation import sudo_plus, user_admin, support_plus
from Nethya.Handlers.extraction import extract_user
...
def info(update: Update, context: CallbackContext):
    ...
    if user.id == OWNER_ID:
        ...
        text += "\n┣|• This user is member of 'Nethya Developer Team'."
        disaster_level_present = True
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Nethya_Updates">?</a>]'.format(
            bot.username
        )
