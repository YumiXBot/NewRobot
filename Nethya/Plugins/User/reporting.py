...
from Nethya import INSPECTOR, LOGGER, REQUESTER, dispatcher
from Nethya.Handlers.validation import user_admin, user_not_admin, is_user_admin
from Nethya.Plugins.Admin.log_channel import loggable
from Nethya.Database import reporting_sql as sql
    ...
    if chat.type == chat.PRIVATE:
        if len(args) >= 1:
            if args[0] in ("yes", "on"):
                ...
                msg.reply_text(
                    "Turned on reporting! You'll be notified whenever anNethya reports something."
                )
